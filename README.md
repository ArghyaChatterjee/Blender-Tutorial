...
* **How to import meshes and point clouds in blender?**
...
* **How to export meshes and point clouds in blender?**
...
* **How to joint 2 meshes in blneder?**
...
* **How to change an object rotation?**
...
* **How to apply transform/set a translation, rotation, and scale to default (0, 0, 0) of an object in blender?**

Answer:

Make the Transform --> Select the object --> ctrl + A --> Apply the Transform operation as needed (Translation/Rotation/Scale)

* **How can an object dimension / 2 points distance be measured in blender?**
...
* **How to transform an object mesh from an arbitrary position to the origin in blender?**
...
* **How to mirror meshes in blender?**

Answer:

- Select the hand.
- Press **Shift + D**, then **Enter** (duplicate).
...
* **How to add a Texture file in blender mesh ?**
...
* **How to create a sphere in blender?**
...
* **How to create a plane in blender which is in the middle of 2 surfaces ?**
...
* **How to add vertex and edge in blender?**
...
* **How to change the background of the 3D viewport in Blender ?**
...
* **How to hide 3D cursor, Axes, Floor, Origin point in Blender 3D viewport ?**
...
* **How to show bounding box, individual axis and wire frame mesh and other properties of objects visible in object mode ?**

Answer:

On the right pane --> Object (object properties) --> turn on the options as necessary.

* **How to render point cloud in blender?**
...
* **How to work with Blender Python API ?**
